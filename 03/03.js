...
let computeCrossPoints = (wireRoutes) => {
  ...
  console.log(wireOneRoute)
  console.log(wireTwoRoute)
  ...
  console.log(`computeCrossPoints complete ${crossPoints}`);
...
let getManhattanDistanceToClosestIntersection = (wireInstructions) => {
  ...
  let closestCross = getClosestCross(crossPoints);
  let manhattanDistance = computeManhattanDistance([0, 0], closestCross);
  return manhattanDistance;
}
...
testIt(getManhattanDistanceToClosestIntersection(exampleInput), 6);

let negativeInput = [
  [ 'L8', 'D8', 'R7', 'D3' ],
  [ 'D8', 'L1', 'D1', 'L1' ]
];
testIt(getManhattanDistanceToClosestIntersection(negativeInput), 9);



loadInput('./03-example-input-1.txt').then((wireInstructions) => {
  let output = testIt(getManhattanDistanceToClosestIntersection(wireInstructions), 159);
  console.log(output);
});

loadInput('./03-example-input-2.txt').then((wireInstructions) => {
  let output = testIt(getManhattanDistanceToClosestIntersection(wireInstructions), 135);
  console.log(output);
});
